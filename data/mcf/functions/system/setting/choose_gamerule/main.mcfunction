...
scoreboard players set @p[tag=MCF_Host,nbt={Inventory:[{Slot:23b,id:"minecraft:fire_coral_fan",tag:{Tags:["MCFsetting","daylight_cycle"]}}]}] Select23 0
...
execute if score #mcf DaylightCycle matches 0 run scoreboard players set @p[tag=MCF_Host,nbt={Inventory:[{Slot:14b,id:"minecraft:redstone_lamp",tag:{Tags:["MCFsetting","off"]}}]}] Select14 0
execute if score #mcf DaylightCycle matches 1 run scoreboard players set @p[tag=MCF_Host,nbt={Inventory:[{Slot:14b,id:"minecraft:glowstone",tag:{Tags:["MCFsetting","on"]}}]}] Select14 0
...
execute as @p[tag=MCF_Host,scores={Select23=1}] run function mcf:system/setting/choose_gamerule/select_daylight_cycle
