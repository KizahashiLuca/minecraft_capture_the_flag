...
## Set inventory
loot replace entity @p[tag=MCF_Host] inventory.4 loot mcf:setting/choose_setting/choose_phase_of_preparation_time
...
execute if score #mcf TimeOfPrepare matches 1.. run loot replace entity @p[tag=MCF_Host] inventory.25 loot mcf:setting/common/determine