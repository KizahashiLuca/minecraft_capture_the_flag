...
execute as @e[type=minecraft:item,scores={ThrowItem=1}] run function mcf:system/setting/choose_phase_of_preparation_time/drop
...
execute if score #mcf TimeOfPrepare matches 1.. run scoreboard players set @p[tag=MCF_Host] Select34 1

scoreboard players set @p[tag=MCF_Host,nbt={Inventory:[{Slot:13b,id:"minecraft:stone_pickaxe",tag:{Tags:["MCFsetting","choose_phase_of_preparation_time"]}}]}] Select13 0
...
execute as @p[tag=MCF_Host,scores={Select13=1}] run function mcf:system/setting/choose_phase_of_preparation_time/change_to
execute as @p[tag=MCF_Host,scores={Select19=1}] run function mcf:system/setting/choose_phase_of_preparation_time/select_digit_0100
execute as @p[tag=MCF_Host,scores={Select20=1}] run function mcf:system/setting/choose_phase_of_preparation_time/select_digit_0010
execute as @p[tag=MCF_Host,scores={Select21=1}] run function mcf:system/setting/choose_phase_of_preparation_time/select_digit_0001
execute as @p[tag=MCF_Host,scores={Select22=1}] run function mcf:system/setting/choose_phase_of_preparation_time/change_to
execute as @p[tag=MCF_Host,scores={Select23=1}] run function mcf:system/setting/choose_phase_of_preparation_time/change_to
execute as @p[tag=MCF_Host,scores={Select24=1}] run function mcf:system/setting/choose_phase_of_preparation_time/change_to
execute as @p[tag=MCF_Host,scores={Select25=1}] run function mcf:system/setting/choose_phase_of_preparation_time/change_to
execute as @p[tag=MCF_Host,scores={Select28=1}] run function mcf:system/setting/choose_phase_of_preparation_time/select_cancel
execute as @p[tag=MCF_Host,scores={Select31=1}] run function mcf:system/setting/choose_phase_of_preparation_time/select_reset
execute as @p[tag=MCF_Host,scores={Select34=1}] run function mcf:system/setting/choose_phase_of_preparation_time/select_ok