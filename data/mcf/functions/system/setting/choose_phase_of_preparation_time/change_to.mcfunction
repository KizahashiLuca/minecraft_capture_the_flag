...
## Set scoreboard
scoreboard players operation @p[tag=MCF_Host] Digit0100 = #mcf TimeOfPrepare
scoreboard players operation @p[tag=MCF_Host] Digit0100 /= #mcf 100
scoreboard players operation @p[tag=MCF_Host] Digit0010 = #mcf TimeOfPrepare
...
scoreboard players operation @p[tag=MCF_Host] Digit0001 = #mcf TimeOfPrepare
