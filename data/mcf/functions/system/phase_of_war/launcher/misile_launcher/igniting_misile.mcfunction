...
scoreboard players operation @e[type=minecraft:area_effect_cloud,tag=MCF_IgnitingMisile,limit=1] RocketUUID0 = @s RocketUUID0
scoreboard players operation @e[type=minecraft:area_effect_cloud,tag=MCF_IgnitingMisile,limit=1] RocketUUID1 = @s RocketUUID1
scoreboard players operation @e[type=minecraft:area_effect_cloud,tag=MCF_IgnitingMisile,limit=1] RocketUUID2 = @s RocketUUID2
scoreboard players operation @e[type=minecraft:area_effect_cloud,tag=MCF_IgnitingMisile,limit=1] RocketUUID3 = @s RocketUUID3
